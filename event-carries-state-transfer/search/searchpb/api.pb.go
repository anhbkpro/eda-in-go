...
const file_searchpb_api_proto_rawDesc = "" +
	"\n" +
	"\x12searchpb/api.proto\x12\bsearchpb\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf9\x02\n" +
	"\x05Order\x12\x19\n" +
	...
	"\x05order\x18\x01 \x01(\v2\x0f.searchpb.OrderR\x05order2\xa5\x01\n" +
	"\rSearchService\x12O\n" +
	"\fSearchOrders\x12\x1d.searchpb.SearchOrdersRequest\x1a\x1e.searchpb.SearchOrdersResponse\"\x00\x12C\n" +
	"\bGetOrder\x12\x19.searchpb.GetOrderRequest\x1a\x1a.searchpb.GetOrderResponse\"\x00B\x80\x01\n" +
	"\fcom.searchpbB\bApiProtoP\x01Z&eda-in-golang/search/searchpb/searchpb\xa2\x02\x03SXX\xaa\x02\bSearchpb\xca\x02\bSearchpb\xe2\x02\x14Searchpb\\GPBMetadata\xea\x02\bSearchpbb\x06proto3"
